  ...
  return (
    <>
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-emerald-500 dark:bg-emerald-800">
          <ul class="space-y-2 font-medium">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-emerald-600 dark:hover:bg-emerald-700 group"
              >
                <svg
