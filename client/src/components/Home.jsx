  ...
  <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 items-center">
    ...
    <div className="mr-auto place-self-center lg:col-span-7">
      <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white text-gray-700">
        Track today and thrive for tomorrow
      </h1>
      <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
        Financial freedom begins with knowing where your money goes. Expenz helps you take control, turning every purchase into a conscious
        decision and every saving into a step toward a secure future. Track
    ...
    <div className="lg:col-span-5 lg:flex justify-end relative">
      <img
        className="w-full lg:w-auto lg:max-w-md lg:ml-8 xl:ml-12"
        src={BannerImage}
        alt="mockup"
      />
    </div>
